...
Point(14) = {0,-hy/2+st/2, 0, lc};
Point(15) = {0,-hy/2-st/2, 0, lc};
Point(16) = {d, -hy/2+st/2, 0, lc};
Point(17) = {d, -hy/2-st/2, 0, lc};
Point(18) = {-hx+d/2, -hy/2+st/2, 0, lc2};
Point(19) = {-hx+d/2, -hy/2-st/2, 0, lc2};
