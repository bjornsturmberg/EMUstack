// Template mesh geometry file asymmetric cross.
// 1) Choose width and height parameters wisely, or it won't look like a
//    cross.
// 2) The same applies for the smoothing parameter
...
// Center
Point(10) = {0.5*d+r1v, -0.5*dy+r2, 0,lc2};
Point(11) = {0.5*d-r1v, -0.5*dy+r2, 0,lc2};
Point(12) = {0.5*d-r1v, -0.5*dy-r2, 0,lc2};
Point(13) = {0.5*d+r1v, -0.5*dy-r2, 0,lc2};

// Inner mesh points
Point(50) = {0.5*d+0.8*r1v, -0.5*dy+0.8*r2, 0,lc2};
Point(51) = {0.5*d-0.8*r1v, -0.5*dy+0.8*r2, 0,lc2};
Point(52) = {0.5*d-0.8*r1v, -0.5*dy-0.8*r2, 0,lc2};
Point(53) = {0.5*d+0.8*r1v, -0.5*dy-0.8*r2, 0,lc2};
