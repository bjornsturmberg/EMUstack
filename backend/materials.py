...
rGO_2018_1_5 = Material(np.loadtxt('%srGO_2018_1_5.txt' % data_location))
rGO_2018_1_0 = Material(np.loadtxt('%srGO_2018_1_0.txt' % data_location))
rGO_2018_fit2_1_0 = Material(np.loadtxt('%srGO_2018_fit2_1_0.txt' % data_location))
rGO_2018_fit_1_0 = Material(np.loadtxt('%srGO_2018_fit_1_0.txt' % data_location))
rGO_2018_fit_2_0 = Material(np.loadtxt('%srGO_2018_fit_2_0.txt' % data_location))
rGO_2018_fit_3_0 = Material(np.loadtxt('%srGO_2018_fit_3_0.txt' % data_location))
rGO_2018_fit_4_0 = Material(np.loadtxt('%srGO_2018_fit_4_0.txt' % data_location))
rGO_2018_fit_5_0 = Material(np.loadtxt('%srGO_2018_fit_5_0.txt' % data_location))
rGO_2018_0_5 = Material(np.loadtxt('%srGO_2018_0_5.txt' % data_location))
rGO_2018_0_4 = Material(np.loadtxt('%srGO_2018_0_4.txt' % data_location))
rGO_2018_0_3 = Material(np.loadtxt('%srGO_2018_0_3.txt' % data_location))
rGO_2018_0_2 = Material(np.loadtxt('%srGO_2018_0_2.txt' % data_location))
rGO_2018_0_1 = Material(np.loadtxt('%srGO_2018_0_1.txt' % data_location))
rGO_2018_2500 = Material(np.loadtxt('%srGO_2018_2500.txt' % data_location))
rGO_2018_2500_0_5 = Material(np.loadtxt('%srGO_2018_2500_0_5.txt' % data_location))
rGO_2018_2500_0_4 = Material(np.loadtxt('%srGO_2018_2500_0_4.txt' % data_location))
rGO_2018_2500_0_3 = Material(np.loadtxt('%srGO_2018_2500_0_3.txt' % data_location))
rGO_2018_2500_0_2 = Material(np.loadtxt('%srGO_2018_2500_0_2.txt' % data_location))
rGO_2018_2500_0_1 = Material(np.loadtxt('%srGO_2018_2500_0_1.txt' % data_location))
rGO_2018_2500_t = Material(np.loadtxt('%srGO_2018_2500_t.txt' % data_location))
