...
# light parameters
wl_1     = 310
wl_2     = 400   # < 400 Im(n(cSi)) large
wl_3     = 1010  # > 110 Im(n(cSi)) = 0
wl_4     = 1110
wl_5     = 1127
...
# Set up solar cell
solar_cell  = objects.SolarCell(radius, period)
...
Efficiency = plotting.irradiance('Absorptance','../Program/Data/ASTM_1_5_spectrum','Weighted_Abs')
# Plot sprectra
spec_list = ['Absorptance', 'Weighted_Abs', 'Transmittance', 'Reflectance']
