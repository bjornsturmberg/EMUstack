...
The extensive human-readable documentation for BlochCode lives in doc/_build/html/ and as a PDF in doc/_build/latex/

Example Sage notebook files are provided in the examples folder.  You will need to adjust the paths in the notebook to point to your BlochCode installation.
